...
public class Ventana extends javax.swing.JFrame {
    ...
    private void jButton_empresa_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_empresa_borrarActionPerformed
        ...
        if (datosAsociadosEmpresa(empresa)) {
    ...
    private void jTable_oficinaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_oficinaMouseClicked
        ...
        Empresa empresa = oficina.getEmpresa();
        jComboBox_oficina_empresa.setSelectedItem(empresa);
    ...
    private void jButton_oficina_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_borrarActionPerformed
        ...
        if (datosAsociadosOficina(oficina)) {
            JOptionPane.showMessageDialog(this, "Imposible eliminar. "
                    + "\n\nContiene datos asociados a la entidad. "
                    + "\nAntes debe eliminar los datos asociados.", "Error", JOptionPane.WARNING_MESSAGE);
        }else {
            try {
                eliminarOficina(oficina);
                cargarListas();
                cargarTablaOficina();
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Problema en la comunicación con la base de datos", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton_oficina_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_guardarActionPerformed
        ...
        if (direccion_oficina.equals("") || telefono_oficina.equals("") || email.equals("") || encargado.equals("")) {
            ...
            try {
                Empresa empresa = (Empresa)jComboBox_oficina_empresa.getSelectedItem();
    ...
    private void jTable_repartidorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_repartidorMouseClicked
        ...
        Oficina oficina = repartidor.getOficina();
        jComboBox_repartidor_oficina.setSelectedItem(oficina);
    ...
    private void jButton_repartidor_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_repartidor_borrarActionPerformed
        ...
        if (datosAsociadosRepartidor(repartidor)) {
            JOptionPane.showMessageDialog(this, "Imposible eliminar. "
                    + "\n\nContiene datos asociados a la entidad. "
                    + "\nAntes debe eliminar los datos asociados.", "Error", JOptionPane.WARNING_MESSAGE);
        ...
        if (dni.equals("") || nombre_repartidor.equals("") || telefono_repartidor.equals("") || jTextField_repartidor_antiguedad.getText().equals("")) {
            ...
            try {
                ...
                if (antiguedad < 0) {
                    ...
                    Oficina oficina = (Oficina) jComboBox_repartidor_oficina.getSelectedItem();
    ...
    private void jTable_paqueteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_paqueteMouseClicked
        ...
        Repartidor repartidor = paquete.getRepartidor();
        jComboBox_paquete_repartidor.setSelectedItem(repartidor);
    ...
    private void jButton_paquete_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_paquete_guardarActionPerformed
        ...
        if (direccion_destino.equals("") || telefono_destino.equals("") || direccion_origen.equals("") || telefono_origen.equals("")) {
            ...
            try {
                ...
                Repartidor repartidor = (Repartidor) jComboBox_paquete_repartidor.getSelectedItem();
    ...
    private javax.swing.JComboBox<Empresa> jComboBox_oficina_empresa;
    private javax.swing.JComboBox<Repartidor> jComboBox_paquete_repartidor;
    private javax.swing.JComboBox<Oficina> jComboBox_repartidor_oficina;
    ...
    private void cargarListas() {
        ...
        oficinaControlador.leerOficina();
        ...
        repartidorControlador.leerRepartidor();
        ...
        paqueteControlador.leerPaquete();
    ...
    private void cargarListaEmpresasMostradas(){
        ...
        System.out.println("listaEmpresas en vista " + listaEmpresas.size());
        ...
        System.out.println("listaEmpresasMostradas en vista " + listaEmpresasMostradas.size());
    }
    ...
    private boolean datosAsociadosEmpresa(Empresa empresa){
        ...
        while (it_oficina.hasNext() && datosAsociados == false) {
            ...
            if (o.getEmpresa() == empresa) {//o .equals
                datosAsociados = true;
            }
        }
    ...
    private boolean datosAsociadosOficina(Oficina oficina){
        boolean datosAsociados = false;
        ...
        while (it_repartidor.hasNext() && datosAsociados == false) {
            ...
            if (r.getOficina() == oficina) {//o .equals
                datosAsociados = true;
            }
        }
        return datosAsociados;
    ...
    private boolean datosAsociadosRepartidor(Repartidor repartidor){
        boolean datosAsociados = false;
        ...
        while (it_paquete.hasNext() && datosAsociados == false) {
            ...
            if (p.getRepartidor() == repartidor) { //o .equals
                datosAsociados = true;
            }
        }
        return datosAsociados;
    ...
    public void modificarEmpresa(int filaSeleccionada, String nombre_empresa, String cif, String director, String web) {
        ...
        empresaControlador.modificarEmpresa(empresa, nombre_empresa, cif, director, web);
    }
    
    public void eliminarEmpresa(Empresa empresa) {
        empresaControlador.eliminarEmpresa(empresa);
    }
    ...
    private void cargarComboOficina(){
        ...
        for (int i = 0; i < listaEmpresasMostradas.size(); i++) {
            jComboBox_oficina_empresa.addItem(listaEmpresasMostradas.get(i));
        }
    }
   
    private void aniadirOficina(String direccion_oficina, String telefono_oficina, String email, String encargado, Empresa empresa) {
        oficinaControlador.insertarOficina(direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void modificarOficina(int filaSeleccionada, String direccion_oficina, String telefono_oficina, String email, String encargado, Empresa empresa) {
        Oficina oficina = listaOficinasMostradas.get(filaSeleccionada);
        oficinaControlador.modificarOficina(oficina, direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void eliminarOficina(Oficina oficina) {
        oficinaControlador.eliminarOficina(oficina);
    }
    ...
    private void cargarComboRepartidor(){
        ...
        for (int i = 0; i < listaOficinasMostradas.size(); i++) {
            jComboBox_repartidor_oficina.addItem(listaOficinasMostradas.get(i));
        }
    }
    
    private void aniadirRepartidor(String dni, String nombre_repartidor, 
            String telefono_repartidor, int antiguedad, Oficina oficina) {
        
        repartidorControlador.insertarRepartidor(dni, nombre_repartidor, 
                telefono_repartidor, antiguedad, oficina);
    }
    
    private void modificarRepartidor(int filaSeleccionada, String dni, String nombre_repartidor,
            String telefono_repartidor, int antiguedad, Oficina oficina) {
        
        Repartidor repartidor = listaRepartidoresMostrados.get(filaSeleccionada);
        repartidorControlador.modificarRepartidor(repartidor, dni, nombre_repartidor, 
                telefono_repartidor, antiguedad, oficina);
    }
                
    private void eliminarRepartidor(Repartidor repartidor) {
        repartidorControlador.eliminarRepartidor(repartidor);
    }
    ...
    private void cargarComboPaquete(){
        ...
        for (int i = 0; i < listaRepartidoresMostrados.size(); i++) {
            jComboBox_paquete_repartidor.addItem(listaRepartidoresMostrados.get(i));
        }
    }
    
    private void aniadirPaquete(Date fecha_entrega, String direccion_destino, String telefono_destino,
            String direccion_origen, String telefono_origen, Repartidor repartidor) {
        
        paqueteControlador.insertarPaquete(fecha_entrega, direccion_destino, telefono_destino,
                direccion_origen, telefono_origen, repartidor);
    }
    
    private void modificarPaquete(int filaSeleccionada, Date fecha_entrega, String direccion_destino,
        ...
        paqueteControlador.modificarPaquete(paquete, fecha_entrega, direccion_destino,
                telefono_destino, direccion_origen, telefono_origen, repartidor);
    }
    
    private void eliminarPaquete(Paquete paquete) {
        paqueteControlador.eliminarPaquete(paquete);
    }
